...
if __name__=='__main__':
    ...
    install_dir = f'{env}/lib/{version}/easyadmin'
    if 'install' in sys.argv:
        try:
            os.makedirs(install_dir)
            os.system(f'cp easyadmin/*.py README.md {install_dir}')
            print("easyadmin successfully installed - see https://github.com/codemation/easyadmin for usage")
